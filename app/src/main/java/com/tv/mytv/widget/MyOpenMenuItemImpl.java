...
public class MyOpenMenuItemImpl implements OpenMenuItem {

    private int mIconID; // icon 资源 id.
    private String mIconUrl; // item id.
    ...
    MyOpenMenuItemImpl(OpenMenu menu, String iconUrl, CharSequence title) {
        this.mMenu = menu;
...
//        this.mId = id;
    ...
    public OpenMenuItem setIconUrl(String iconUrl) {
        this.mIconUrl = iconUrl;
        return this;
    }
