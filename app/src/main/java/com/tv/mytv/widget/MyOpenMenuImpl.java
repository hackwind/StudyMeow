 ...
 * @author hailongqiu
 */
public class MyOpenMenuImpl implements OpenMenu {
    ...
    public OpenMenuItem add(CharSequence title) {
        return addInternal("", title);
    }

    public OpenMenuItem add(CharSequence title,String iconUrl) {
        return addInternal(iconUrl, title);
    }
